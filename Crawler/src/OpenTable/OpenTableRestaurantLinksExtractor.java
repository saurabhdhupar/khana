...
import urbanspoon.UrbanSpoonRestaurant;
...
public class OpenTableRestaurantLinksExtractor {
	...
	private void extarctRestaurantDetails(String resutarantLink) throws IOException {
	...
	public static void main(String args[]) throws IOException {
		...
		for (String restaurantUrl : restaurantUrlList) {
			extract.extarctRestaurantDetails(restaurantUrl);
		}
	}
